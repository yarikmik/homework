...
while not network_correct:
		for i in network:
			...
			"""
			elif int(network[0])<0 or int(network[0])>255 or int(network[1])<0 or int(network[1])>255 or int(network[2])<0 or int(network[2])>255 or int(network[3])<0 or int(network[3])>255:
